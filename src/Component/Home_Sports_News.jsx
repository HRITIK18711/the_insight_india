...
const cards = [
  { title: "Treks to Explore", img: "/Image/Delhi.png" },
  { title: "Food to Explore ", img: "/Image/food.jpg" },
  { title: "Yatras to Explore", img: "/Image/culture.jpg" },
  { title: "Hidden Getaway", img: "/Image/water.jpg" },
];
  ...
  return (
    <div className="w-full px-4 sm:px-6 py-12 bg-transparent">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-black mb-8">Treks and Temples</p>
